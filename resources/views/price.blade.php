...
<div id="mitsumori-js">
        ...
        <tbody>
            <tr id="mitsumori-js-item-1" class="mitsumori-js-item" data-itemnum="1">
                ...
                <td class="item-quantity">
                    <label><input type="radio" name="item-radio-1" class="radio-quantity" data-itemnum="1" value="3000">サイズS</label>
                    <label><input type="radio" name="item-radio-1" class="radio-quantity" data-itemnum="1" value="4000">サイズM</label>
                    <label><input type="radio" name="item-radio-1" class="radio-quantity" data-itemnum="1" value="5000">サイズL</label>
                </td>
            ...
            <tr id="mitsumori-js-item-2" class="mitsumori-js-item" data-itemnum="2">
                ...
                <td class="item-quantity">
                    <label><input type="radio" name="item-radio-2" class="radio-quantity" data-itemnum="2" value="1000">サイズS</label>
                    <label><input type="radio" name="item-radio-2" class="radio-quantity" data-itemnum="2" value="1500">サイズM</label>
                    <label><input type="radio" name="item-radio-2" class="radio-quantity" data-itemnum="2" value="2000">サイズL</label>
                </td>
                <td class="item-price">￥<span></span></td>
            </tr>
            <tr id="mitsumori-js-item-3" class="mitsumori-js-item" data-itemnum="3">
                ...
                <td class="item-quantity">
                    <label><input type="radio" name="item-radio-3" class="radio-quantity" data-itemnum="3" value="1000">わたタイプ</label>
                    <label><input type="radio" name="item-radio-3" class="radio-quantity" data-itemnum="3" value="2000">木タイプ</label>
                </td>
                <td class="item-price">￥<span></span></td>
            </tr>
            <tr id="mitsumori-js-item-4" class="mitsumori-js-item" data-itemnum="4">
                ...
                <td class="item-quantity">
                    <label><input type="radio" name="item-radio-4" class="radio-quantity" data-itemnum="4" value="500">ペットフードA(かりかりタイプ) </label>
                    <label><input type="radio" name="item-radio-4" class="radio-quantity" data-itemnum="4" value="600">ペットフードB(ソフトタイプ) </label>
                </td>
                <td class="item-price">￥<span></span></td>
            </tr>
            <tr id="mitsumori-js-item-6" class="mitsumori-js-item" data-itemnum="6">
                ...
                <td class="item-quantity">
                    <label><input type="checkbox" class="check-quantity" data-itemnum="6" value="200">トウモロコシ</label>
                    <label><input type="checkbox" class="check-quantity" data-itemnum="6" value="300">ひまわりの種</label>
                </td>
                <td class="item-price">￥<span></span></td>
            </tr>
            <tr id="mitsumori-js-item-8" class="mitsumori-js-item" data-itemnum="8">
                ...
                <td class="item-quantity">
                    <label><input type="radio" name="item-radio-8" class="radio-quantity" data-itemnum="8" value="1500">加入する</label>
                    <label><input type="radio" name="item-radio-8" class="radio-quantity" data-itemnum="8" value="0">加入しない</label>
                </td>
                <td class="item-price">￥<span></span></td>
            </tr>
        </tbody>
    ...
    <table class="mitsumori-js-total-tbl" data-taxflg="1">
        <tbody>
            <tr><th>小計</th><td>￥<span id="mitsumori-js-subtotal"></span></td></tr>
            <tr><th>消費税（<span id="mitsumori-js-tax-rate">10</span>%）</th><td>￥<span id="mitsumori-js-tax"></span></td></tr>
